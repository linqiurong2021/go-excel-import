 ...
 * @ Modified time: 2020-10-12 11:07:24
 * @ Description: 自定义弹窗 线 信息
 -->

<template>
    <my-dialog title="基本信息(线)" class="baseinfo-wrap"
  ...
  methods: {
    ...
    iconClick(key) {
      ...
      if(key == this.btnList.length - 1){
        this.$store.dispatch('business/setDetailInfoComponent',{componentsName: 'Detail', Data: this.temp })
      }
    }
  },
};
