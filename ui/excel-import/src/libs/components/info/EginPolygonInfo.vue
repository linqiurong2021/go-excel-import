<!--
 * @ Author: linqiurong
 * @ Create Time: 2020-09-28 18:37:28
 * @ Modified by: linqiurong
 * @ Modified time: 2020-10-12 11:07:50
 * @ Description: 自定义弹窗 面 信息
 -->

<template>
    <my-dialog title="基本信息(面)" class="baseinfo-wrap"
  ...
  methods: {
    ...
    iconClick(key) {
      ...
      if(key == this.btnList.length - 1){
        this.$store.dispatch('business/setDetailInfoComponent',{componentsName: 'Detail2', Data: this.temp })
      }
    }
  },
};
